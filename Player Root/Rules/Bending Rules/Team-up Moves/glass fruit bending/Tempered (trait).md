...
- +25% effective HP for wall/structure effects created from the fruit.
- +1 to stability checks vs. fracture or spirit-corruption.
- Fire-Level effects gain +1 tier on success in some recipes.

Tags: #trait #mechanics #glassfruit #tempered

Storytelling / short use-case (skillcheck):
