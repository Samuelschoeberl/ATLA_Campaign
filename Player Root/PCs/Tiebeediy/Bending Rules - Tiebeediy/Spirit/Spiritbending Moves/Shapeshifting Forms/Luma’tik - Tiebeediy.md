...
| **Stat**                       | **Value**   |
| ------------------------------ | ----------- |
| **Strength (0) (STR (5))**     | 4 (-3)      |
| **Dexterity (0) (Dex (3))**    | **16 (+3)** |
...
- **Sparkbite:** Melee Weapon Attack, Spirit Attack Roll (1d20 + 2 + 3)to hit, 1d6 piercing and 1d4 radiant damage. If attacking from stealth, deals an extra 1d4 radiant damage.
    
- **Lightshard Dart:** Ranged Attack, Spirit Attack Roll (1d20 + 2 + 3) to hit, 1d6 radiant damage. On hit, target has disadvantage on Perception checks for 1 minute.
