...
Element Level (0):
	Firebending (0): Level 2 (0) 
	Earthbending (0): Level 1 (0)
...
| **Stat**                       | **Value**   |
| ------------------------------ | ----------- |
| **Strength (0) (STR (1))**     | 4 (-3)      |
| **Dexterity (0) (Dex (2))**    | **16 (+3)** |
| **Constitution (0) (Con (3))** | 12 (+1)     |
| Wisdom (0)(WIS (5))            | 10(+0)      |
| Intelligence (0)(Int (4))      | 8(-1)       |
...
- **Mirage Flicker (1/Short Rest (0)):** As a Bonus Action (0), Luma’tik can create up to two illusionary duplicates for 1 minute. Each duplicate mimics its movements and grants attackers disadvantage on attack rolls until they hit Luma’tik.
...
- **Sparkbite:** Melee Weapon Attack, Spirit Attack Roll (1d20 + 20 + 2)to hit, 1d6 piercing and 1d4 radiant damage. If attacking from stealth, deals an extra 1d4 radiant damage.
    
- **Lightshard Dart:** Ranged Attack, Spirit Attack Roll (1d20 + 20 + 2) to hit, 1d6 radiant damage. On hit, target has disadvantage on Perception checks for 1 minute.
